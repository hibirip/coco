...
// 주요 코인 심볼들 (WebSocket 구독용) - 상위 30개 코인
const MAJOR_SYMBOLS = [
  // 상위 10개 주요 코인
  ...
  'ATOMUSDT', 'FILUSDT', 'MANAUSDT', 'SANDUSDT', 'AXSUSDT',
  'CHZUSDT', 'ENJUSDT', 'VETUSDT', 'MATICUSDT', 'ICPUSDT',
  'APTUSDT', 'NEARUSDT', 'FLOWUSDT', 'ALGOUSDT', 'XTZUSDT',
  'AAVEUSDT', 'MKRUSDT', 'COMPUSDT', 'SNXUSDT', 'CRVUSDT',
  'SUSHIPUSDT', 'YFIUSDT', 'BALUSDT', 'LRCUSDT', 'ZRXUSDT'
];
